...
<div class="background">
	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
			...
			<div style="display: flex;">	
				...
				<div style="min-height: 400px;flex:1;">
					...
					<img id="profile_pic" src="<?php echo ROOT . $image ?>"><br/>
						...
						<a href="<?=ROOT?>profile" style="text-decoration: none; color:white;"> 
		...
		<footer style="background: #2c3e50; color: #ffffff; padding: 25px; text-align: center; font-family: Arial, sans-serif;">
    <h2 style="margin-bottom: 10px;">✨ Khaati – Authentic Flavors, Real Stories ✨</h2>
    <p style="margin-bottom: 10px; font-size: 18px;">🌿 Pure Ingredients | Timeless Recipes | True Taste</p>
    <p style="margin-bottom: 15px;">📍 Bringing You the Essence of Tradition & Culture</p>
    <p><strong>📢 Stay Updated with Our Latest Recipes, Tips & Stories!</strong></p>
    
    <div class="contact-info" style="margin-top: 15px;">
        <p><strong>📩 DM for Collaborations & Orders</strong></p>
    ...
    <div class="social-links" style="margin-top: 15px;">
        <p><strong>🌍 Follow & Connect with Us:</strong></p>
    ...
    <div class="tag-us" style="margin-top: 15px;">
        <p><strong>📸 Tag Us & Get Featured:</strong> #KhaatiVibes #TasteTheAuthenticity</p>
    </div>
    
    <div class="newsletter" style="margin-top: 20px;">
        <p><strong>💌 Subscribe to Our Newsletter for Exclusive Updates & Offers!</strong></p>
    ...
    <p style="margin-top: 20px; font-size: 14px;">🍽️ <strong>Because Every Meal Tells a Story!</strong> ❤️</p>
</footer>
	</body>
</html>